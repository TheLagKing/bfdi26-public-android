...
class FlxObjectTools
{
	...
	static inline public function addAndPlay(sprite:FlxSprite,name:String,prefix:String,fps:Int = 24,looped:Bool = true):FlxSprite
	{
	...
	static inline public function playAnimation(sprite:FlxSprite,name:String,forced:Bool = true):FlxSprite
	{
	...
	*/
	...
	{
		if (!ClientPrefs.data.shaders) return sprite;
