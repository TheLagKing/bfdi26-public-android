...
//taken from geokurelis tests
//https://github.com/Geokureli/flixel-tests/blob/main/Source/flixel/addons/text/FlxTextTyper.hx
class FlxTextTyper extends FlxBasic
{
	 ...
	 */
	public var delay:FlxTypeDelay = CONST(0.055);
	 ...
	 */
	public var charDelayScaler:Map<String, Float> = [','=>3.5, '.'=>4.0,'?'=>4.0, '!'=>4.0, '-'=>6.0];
...
@:using(funkin.backend.FlxTextTyper.FlxTypeDelayTools)
enum FlxTypeDelay
{
	CONST(delay:Float);
