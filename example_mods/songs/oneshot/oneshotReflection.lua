local characters = {'dadPhantom','bfPhantom'}
...
--------------------------------------------------
    ...
    if showBF then
        ...
        setObjectOrder('bfPhantom',getObjectOrder('boyfriendGroup')-2)
        ...
        setProperty('bfPhantom.flipY', true)
         setProperty('bfPhantom.y',(getProperty('boyfriend.y')-7.5) + getProperty('boyfriend.frameHeight')*getProperty('boyfriend.scale.y') * 2 - bfoffsetY * 2 + BFYFix)
    end
...
-----------------------------boyfriend sprite---------------------
    ...
    if showDAD then
        ...
        setObjectOrder('dadPhantom',getObjectOrder('dadGroup')-2)
        ...
        setProperty('dadPhantom.y',(getProperty('dad.y')-7.5) + getProperty('dad.frameHeight') * getProperty('dad.scale.y') * 2 - dadoffsetY * 2 + DADYFix)
    end
...
-----------------------------boyfriend playanim---------------
    ...
    if shadersEnabled then
        setSpriteShader(characters[i],'blur')
        setShaderFloat(characters[i],'directions',30.0)
