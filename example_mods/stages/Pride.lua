...
for _, hudout in ipairs({'uiGroup','textmiss','scoreTxt','hyper','textacc'}) do
...
for p= 4,7 do
noteTweenX('movePlayer'..p, p,1625 + (110 *(p - 4)), 0.25,'cubeInOut')
end

for p= 0,3 do
noteTweenX('moveOpponent'..p, p,-450 + (115 *(p - 4)), 0.25,'cubeInOut')
end
...
scaleObject('blacks',3,3)
addLuaSprite('blacks',false)
screenCenter('blacks', 'xy')
setObjectOrder('blacks',getObjectOrder('gfGroup')-1)
...
makeLuaSprite("ytpmv", null, 275, 423)
...
runHaxeCode([[
FlxTween.tween(dad.colorTransform, { redOffset: 255, greenOffset: 255, blueOffset: 255, redMultiplier: 0, greenMultiplier: 0, blueMultiplier: 0},0.01);
]])
runHaxeCode([[
FlxTween.tween(boyfriend.colorTransform, { redOffset: 255, greenOffset: 255, blueOffset: 255, redMultiplier: 0, greenMultiplier: 0, blueMultiplier: 0},0.01);
]])
runHaxeCode([[
FlxTween.tween(gf.colorTransform, { redOffset: 255, greenOffset: 255, blueOffset: 255, redMultiplier: 0, greenMultiplier: 0, blueMultiplier: 0},0.01);
]])
...
runHaxeCode([[
FlxTween.tween(dad.colorTransform, { redOffset: 0, greenOffset: 0, blueOffset: 0, redMultiplier: 1, greenMultiplier: 1, blueMultiplier: 1},0.01);
]])
runHaxeCode([[
...
runHaxeCode([[
FlxTween.tween(gf.colorTransform, { redOffset: 0, greenOffset: 0, blueOffset: 0, redMultiplier: 1, greenMultiplier: 1, blueMultiplier: 1},0.01);
]])
...
setObjectOrder('ytpmv',getObjectOrder('boyfriendGroup')+1)
setObjectOrder('gfGroup',getObjectOrder('ytpmv')+1)
